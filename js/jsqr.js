...
(function (w, z) {
  ...
  function encodeMatrix(a, b, c) {
    var i, j, x, y, len, version = b.version,
      ecLevel = b.errorCorrection;
    var d = new Array(versionInfo[versionInfo.length - 1][B.TOTAL_BYTES] * 8),
      bitStreamLen = 0,
      cciLength, minVersion;
    switch (b.encodeMode) {
    ...
    var k = Math.floor((versionInfo[version][B.TOTAL_BYTES] - versionInfo[version][B.ECC_BYTES][ecLevel]) / (versionInfo[version][B.EC_BLOCKS][ecLevel][0] + versionInfo[version][B.EC_BLOCKS][ecLevel][1])),
      eccBlockSize = Math.floor(versionInfo[version][B.ECC_BYTES][ecLevel] / (versionInfo[version][B.EC_BLOCKS][ecLevel][0] + versionInfo[version][B.EC_BLOCKS][ecLevel][1])),
      dataBlocks = [],
      codeword = [];
